d3.gantt = function() {
  ...
  // customer names displayed on y-axis
  var customerNames = [];
  ...
  var keyFunction = function(d) {
    return d.TaskDuration.StartDate + d.CustomerInfo.CustomerName + d.TaskDuration.EndDate;
  };


  var rectTransform = function(d) {
    return "translate(" + x(d.TaskDuration.StartDate) + "," + y(d.CustomerInfo.CustomerName) + ")";
  };
  ...
  var setupTimeDomain = function() {
    if (timeDomainMode === FIT_TIME_DOMAIN_MODE) {
      ...
      // set time domain end date
      timeDomainEnd = data[data.length - 1].TaskDuration.EndDate;
      ...
      // set time domain start date
      timeDomainStart = data[0].TaskDuration.StartDate;
    }
  };
      ...
      .enter()
        ...
        .append("rect")
          ...
          .attr("width", function(d) {
            return ( x(d.TaskDuration.EndDate) - x(d.TaskDuration.StartDate) );
          });
  ...
  gantt.customerNames = function(value) {
    if (!arguments.length) return customerNames;
